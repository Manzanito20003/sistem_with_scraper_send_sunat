...
class BoletaApp(QWidget):
    ...
    def initUI(self):
        ...
        self.productos_table = QTableWidget(2, 7)  # Cambiar de 8 a 7 columnas
    ...
    def actualizar_producto_seleccionado(self, row, combo_box):
        ...
        self.productos_table.removeCellWidget(row, 2)  # Remueve el combobox y deja el texto final en la celda

        # 🔹 Asegurar que el nuevo valor se refleja en la tabla
        self.productos_table.setItem(row, 2, QTableWidgetItem(nombre))  # Reemplazar QComboBox por el texto
    ...
    def actualizar_total_producto(self, row: int) -> None:
        ...
        try:
            ...
            if self.productos_table.itemChanged.isSignalConnected(self.actualizar_total_producto):
                self.productos_table.itemChanged.disconnect(self.actualizar_total_producto)
